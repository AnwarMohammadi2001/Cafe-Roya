    ...
    <div className="bg-amber-50 overflow-hidden min-h-[500px]   py-20">
      ...
      >
        ...
        <div
          ...
          className="flex-1 relative overflow-hidden md:flex-[2] h-full space-y-5 text-center bg-white px-14 py-10 rounded-lg"
        >
          {/* Blur Overlay */}
        ...
        {/* Second Div */}
        <div className="flex-1 group bg-gray-100 p-4 rounded-lg space-y-3  flex flex-col justify-center items-center gap-4">
